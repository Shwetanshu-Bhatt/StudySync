  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Floating shapes */}
        <div className="absolute top-20 left-20 w-20 h-20 border border-primary-500/20 rounded-full animate-float" style={{ animationDelay: '0s' }} />
        <div className="absolute bottom-32 right-32 w-32 h-32 border border-secondary-500/20 rounded-full animate-float-reverse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/3 right-1/4 w-16 h-16 border border-accent-500/20 rounded-full animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10 animate-fade-in-up">
          <div className="relative inline-flex mb-6">
            <div className="w-24 h-24 rounded-3xl bg-brand-gradient flex items-center justify-center shadow-2xl shadow-primary-500/40 animate-glow-pulse">
              <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <div className="absolute -inset-2 bg-brand-gradient rounded-3xl blur-xl opacity-40 animate-pulse" />
          </div>
        ...
        <div className="glass-card p-8 animate-fade-in-up stagger-2">
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-400">
              ...
              <Link to="/signup" className="text-primary-400 hover:text-primary-300 font-semibold transition-colors hover:underline decoration-primary-400/30 underline-offset-4">
                Create one
              </Link>
            </p>
          </div>
