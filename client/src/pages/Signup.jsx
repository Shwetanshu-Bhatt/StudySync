...
const Signup = () => {
  ...
  // Google OAuth signup handler - using redirect instead of popup
        ...
        <div className="text-center mb-10 animate-fade-in-up">
          <div className="relative inline-flex mb-6">
            <div className="w-20 h-20 rounded-2xl bg-brand-gradient flex items-center justify-center shadow-2xl shadow-primary-500/40 animate-glow-pulse">
              <img src="/studySync.svg" alt="StudySync Logo" className="w-11 h-11" />
            </div>
        ...
        <div className="glass-card p-8 animate-fade-in-up stagger-2">
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 glass-card text-slate-500">Or sign up with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="mt-5 w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-3"
          >
